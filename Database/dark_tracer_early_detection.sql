...
--
-- Host: localhost
-- Generation Time: Aug 25, 2022 at 12:21 PM
...
--
-- Database: `dark_tracer_early_detection`
--
CREATE DATABASE IF NOT EXISTS `dark_tracer_early_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dark_tracer_early_detection`;
...
('g9l4igqinpishj7t3335qaz7ahgelpzz', 'eyJ1c2VyaWQiOjF9:1oRBQs:pJsSPxrvN7XtHvckHHstrcPK_yviqkyUdAEbQ0LtxN4', '2022-09-08 11:53:58.969048'),
...
('t2ib9uhot9jtf24jndrx8jjhgjb8u4fd', 'eyJ1c2VyaWQiOjN9:1oRBno:rp_BIDOxf502U-y0_kW2_zd0Ed_wPESk25hLgNgdoGs', '2022-09-08 12:17:40.838450'),
...
(1, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Malleshwaram', 'Male'),
(3, 'tmksmanju', 'tmksmanju13@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male');
...
(32, 'Naive Bayes', '90.15748031496062'),
(33, 'SVM', '92.47594050743658'),
(34, 'Logistic Regression', '90.98862642169728'),
(35, 'Decision Tree Classifier', '89.41382327209098'),
(36, 'KNeighborsClassifier', '82.19597550306212'),
(37, 'Naive Bayes', '88.62642169728784'),
(38, 'SVM', '90.85739282589677');
...
(15, 'malware', '66.66666666666666'),
(16, 'legitimate', '33.33333333333333');
...
CREATE TABLE IF NOT EXISTS `remote_user_detection_type` (
  ...
  `https_token` varchar(300) NOT NULL,
...
INSERT INTO `remote_user_detection_type` (`id`, `url`, `length_url`, `length_hostname`, `https_token`, `page_rank`, `Prediction`) VALUES
(1, 'https://support-appleld.com.secureupdate.duilawyeryork.com/ap/89e6a3b4b063b8d/?cmd=_update&dispatch=89e6a3b4b063b8d1b&locale=_\r\n', '126', '50', '0', '0', 'malware'),
(2, 'http://www.mutuo.it\r\n', '19', '12', '1', '1', 'legitimate'),
(3, 'http://wave.progressfilm.co.uk/time3/?logon=myposte\r\n', '51', '23', '1', '4', 'malware'),
(4, 'http://support-appleld.com.secureupdate.duilawyeryork.com/ap/bb14d7ff1fcbf29?cmd=_update&dispatch=bb14d7ff1fcbf29bb&locale=_us\r\n', '126', '50', '1', '0', 'malware'),
(5, 'http://yummy-cummy-in-my-tummy.tumblr.com\r\n', '41', '34', '1', '8', 'legitimate'),
(6, 'http://wave.progressfilm.co.uk/time3/?logon=myposte\r\n', '51', '23', '1', '4', 'malware');
